from keras.layers import Input, Dense, Conv2D, MaxPool2D, Dropout, Lambda, Flatten, ELU, LeakyReLU
import keras.models as models
from keras import regularizers


def DistanceClassifier(input_size, num_classes, include_top=True, version='v1'):
