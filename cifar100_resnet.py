...
class Cifar100Resnet:
    def __init__(self, train_idx=None, pool_idx=None, depth_mult=1, structure = [3,4,6,3]):
        '''
    ...
    def _build_model(self, input_shape=[32, 32, 3], blocks=[3,4,6,3], num_classes=100):
        '''
        ...
        y = Lambda(lambda x: K.dropout(x, level=self.dr1), name='embedding')(y)  # this is a dropout that applied manually for MC-dropout
